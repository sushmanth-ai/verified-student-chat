...
const AppContent = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block fixed left-0 top-0 h-screen w-64 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-r border-gray-200/50 dark:border-gray-700/50 shadow-xl z-40">
        <div className="p-6 border-b border-gray-200/50 dark:border-gray-700/50">
          ...
          <div className="flex items-center space-x-2 mt-4">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/50 dark:to-purple-900/50 rounded-full flex items-center justify-center ring-2 ring-white/50 dark:ring-gray-700/50 shadow-md">
        ...
        <div className="absolute bottom-6 left-0 right-0 px-4">
          <Button 
            ...
            className="w-full bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white rounded-xl py-3 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
          >
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm shadow-lg px-4 py-3 border-b border-gray-200/50 dark:border-gray-700/50 z-50">
      ...
      <div className="lg:ml-64 min-h-screen">
        <div className="lg:hidden pt-16 sm:pt-20 pb-20">
          <ActiveComponent />
        </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-t border-gray-200/50 dark:border-gray-700/50 px-2 py-3 shadow-lg z-50">
