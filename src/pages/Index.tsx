  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20 flex flex-col max-w-md mx-auto border-x border-gray-200/50 dark:border-gray-700/50 shadow-2xl">
        ...
        <div className="fixed top-0 left-1/2 transform -translate-x-1/2 w-full max-w-md bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm shadow-lg px-6 py-4 border-b border-gray-200/50 dark:border-gray-700/50 z-50">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white rounded-xl px-4 py-2 font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 focus:outline-none focus:ring-0 group"
              >
